...
\begin{center}
    {\Huge \scshape Piyusha Shubham Lomate} \\ \vspace{1pt}
    % Rain Tree Park, KPHB, Hyderabad \\ 
    \vspace{5pt}
    \small \raisebox{-0.1\height}\faPhone\ 7249575797 ~ 
    \raisebox{-0.2\height}\faEnvelope\ \href{mailto:piyushaslomte@gmail.com}{ piyushaslomte@gmail.com} ~ 
    \raisebox{-0.2\height}\faLinkedin\ \href{https://www.linkedin.com/in/piyusha-lomate/}{ linkedin.com/in/piyusha-lomate}  ~
    \raisebox{-0.2\height}\faGithub\ \href{https://github.com/ItsPiyusha}{ github.com/ItsPiyusha}
    \vspace{-8pt}
\end{center}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Government College of Engineering and research}{June '15 -- June '19}
      {Bachelor of Technology in Computer Engineering}{Awasari, Pune, India}
  \resumeSubHeadingListEnd
